OBJECTS=./build/compiler.o ./build/cprocess.o ./build/token.o ./build/lex_process.o ./build/lexer.o ./build/node.o ./build/helpers/buffer.o ./build/helpers/vector.o ./build/parser.o
INCLUDES= -I./
